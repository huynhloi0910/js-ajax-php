...
<?php
	...
	if (isset($_GET['id_user']) && isset($_GET['id_product'])) {
		...
		$sql = "SELECT * FROM product WHERE id_user = ".$id_user." && id_product = ".$id_product." ";
    ...
    if (isset($_POST['edit'])) {
        ...
        if ($check) {
            ...
            if (move_uploaded_file($_FILES["image"]["tmp_name"], './uploads/'.$_FILES["image"]["name"])) {
                echo "File ". $_FILES["image"]["name"]." Đã upload thành công";
            } else {
                echo "Không upload được file!";
            }

            $sql = "UPDATE product SET title = '".$title."', price = '".$price."', image = '".$img."'
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <table>
                                <tr>
                                    <td>Title:</td>
                                    <td>
                                        <input type="text" name="title" value="<?php echo isset($value['title']) ? $value['title'] : ''; ?>" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                	...
                                	<td>
										...
										?>
                                    	<img style="width: 100px" src="<?php echo isset($value['image']) ?  './uploads/'.$value['image'] : ''; ?>">
                                    </td>
                                </tr>
